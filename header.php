...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5M4GSLD"
        ...
        <div class="container site-header d-flex justify-content-between">
            <div class="site-branding">
                <div class="d-flex justify-content-start align-items-center">
                    <a href="/" class="custom-logo-link d-none d-md-block">
                        <?php 					$custom_logo__url = wp_get_attachment_image_src( get_theme_mod( 'custom_logo' ), 'full' );
                        ?>
                        <img src="<?php echo $custom_logo__url[0]; ?>" class="custom-logo" alt="Поступление в Италию">
                    </a>
